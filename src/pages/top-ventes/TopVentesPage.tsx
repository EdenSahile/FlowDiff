...
const SALES: Record<string, SalesData> = {
  ...
  /* Fonds BD/Mangas */
  'f-bd-demon-01':   { units: 2341, trend: 'up' },
  'f-bd-demon-02':   { units: 1987, trend: 'up' },
  'f-bd-demon-03':   { units: 1654, trend: 'stable' },
  'f-bd-jjk-01':     { units: 1543, trend: 'up' },
  'f-bd-jjk-02':     { units: 1287, trend: 'up' },
  'f-bd-spy-01':     { units: 1432, trend: 'up' },
  'f-bd-spy-02':     { units: 1198, trend: 'stable' },
  's-mha-02':        { units: 1876, trend: 'stable' },
  's-mha-03':        { units: 1654, trend: 'down' },
  'f-bd-opm-01':     { units: 987,  trend: 'stable' },
  'f-bd-vinland-01': { units: 743,  trend: 'up' },
  /* Fonds Littérature */
  'f-lit-mathieu':   { units: 2156, trend: 'stable' },
  'f-lit-perrin':    { units: 1834, trend: 'up' },
  'f-lit-colombani': { units: 987,  trend: 'down' },
  'f-lit-musso':     { units: 945,  trend: 'down' },
  'f-lit-slimani-pays': { units: 789, trend: 'stable' },
  'f-lit-rooney':    { units: 654,  trend: 'up' },
  'f-lit-houellebecq': { units: 521, trend: 'stable' },
  /* Fonds Jeunesse */
  'f-jes-animaux':   { units: 3412, trend: 'up' },
  'f-jes-passe-03':  { units: 1234, trend: 'stable' },
  'f-jes-hearts-02': { units: 867,  trend: 'up' },
  'f-jes-six-01':    { units: 678,  trend: 'stable' },
  /* Fonds Pratique */
  'f-pra-atomic':    { units: 1245, trend: 'up' },
  'f-pra-ikigai':    { units: 1087, trend: 'stable' },
  'f-pra-01':        { units: 876,  trend: 'down' },
  'f-pra-02':        { units: 567,  trend: 'stable' },
  'f-pra-homo':      { units: 432,  trend: 'down' },
}
