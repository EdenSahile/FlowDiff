  ...
  return (
    ...
    <Card $mode={mode}>
      ...
      <MainRow onClick={() => { if (window.getSelection()?.toString()) return; navigate(`/livre/${book.id}`) }}>
        ...
        {/* Sidebar couverture */}
        <CoverSidebar>
          <BookCover isbn={book.isbn} alt={book.title} width={110} height={154} universe={book.universe} authors={book.authors} publisher={book.publisher} coverUrl={book.coverUrl} />
